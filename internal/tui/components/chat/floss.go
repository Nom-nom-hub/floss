...
// flossMessageListCmp implements a FLOSS-styled message list component
type flossMessageListCmp struct {
	app              *app.App
	width, height    int
...
// NewFloss creates a new FLOSS-styled message list component
func NewFloss(app *app.App) MessageListCmp {
...
func (m *flossMessageListCmp) Init() tea.Cmd {
	return m.listCmp.Init()
}

// Update handles incoming messages and updates the component state.
func (m *flossMessageListCmp) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	var cmds []tea.Cmd
...
// View renders the message list with FLOSS styling
func (m *flossMessageListCmp) View() string {
	...
	// Apply FLOSS-specific styling to the message list
	cardStyles := getFlossCardStyles()
...
// getFlossCardStyles returns the FLOSS-specific card styles
func getFlossCardStyles() struct {
...
func (m *flossMessageListCmp) handlePermissionRequest(perm permission.PermissionNotification) tea.Cmd {
	items := m.listCmp.Items()
	if toolCallIndex := m.findToolCallByID(items, perm.ToolCallID); toolCallIndex != NotFound {
...
func (m *flossMessageListCmp) handleChildSession(event pubsub.Event[message.Message]) tea.Cmd {
	var cmds []tea.Cmd
...
func (m *flossMessageListCmp) handleMessageEvent(event pubsub.Event[message.Message]) tea.Cmd {
	switch event.Type {
...
func (m *flossMessageListCmp) messageExists(messageID string) bool {
	items := m.listCmp.Items()
...
func (m *flossMessageListCmp) handleNewMessage(msg message.Message) tea.Cmd {
	switch msg.Role {
	case message.User:
...
func (m *flossMessageListCmp) handleNewUserMessage(msg message.Message) tea.Cmd {
...
func (m *flossMessageListCmp) handleToolMessage(msg message.Message) tea.Cmd {
	items := m.listCmp.Items()
...
func (m *flossMessageListCmp) findToolCallByID(items []list.Item, toolCallID string) int {
...
func (m *flossMessageListCmp) handleUpdateAssistantMessage(msg message.Message) tea.Cmd {
	var cmds []tea.Cmd
	items := m.listCmp.Items()
...
func (m *flossMessageListCmp) findAssistantMessageAndToolCalls(items []list.Item, messageID string) (int, map[int]messages.ToolCallCmp) {
...
func (m *flossMessageListCmp) updateAssistantMessageContent(msg message.Message, assistantIndex int) tea.Cmd {
...
func (m *flossMessageListCmp) shouldShowAssistantMessage(msg message.Message) bool {
...
func (m *flossMessageListCmp) updateToolCalls(msg message.Message, existingToolCalls map[int]messages.ToolCallCmp) tea.Cmd {
	var cmds []tea.Cmd
...
func (m *flossMessageListCmp) updateOrAddToolCall(msg message.Message, tc message.ToolCall, existingToolCalls map[int]messages.ToolCallCmp) tea.Cmd {
...
func (m *flossMessageListCmp) handleNewAssistantMessage(msg message.Message) tea.Cmd {
	var cmds []tea.Cmd
...
func (m *flossMessageListCmp) SetSession(session session.Session) tea.Cmd {
...
func (m *flossMessageListCmp) buildToolResultMap(messages []message.Message) map[string]message.ToolResult {
...
func (m *flossMessageListCmp) convertMessagesToUI(sessionMessages []message.Message, toolResultMap map[string]message.ToolResult) []list.Item {
...
func (m *flossMessageListCmp) convertAssistantMessage(msg message.Message, toolResultMap map[string]message.ToolResult) []list.Item {
...
func (m *flossMessageListCmp) buildToolCallOptions(tc message.ToolCall, msg message.Message, toolResultMap map[string]message.ToolResult) []messages.ToolCallOption {
...
func (m *flossMessageListCmp) GetSize() (int, int) {
	return m.width, m.height
}

// SetSize updates the component dimensions and propagates to the list component.
func (m *flossMessageListCmp) SetSize(width int, height int) tea.Cmd {
	m.width = width
	m.height = height
	if m.promptQueue > 0 {
...
func (m *flossMessageListCmp) SelectionClear() tea.Cmd {
...
func (m *flossMessageListCmp) CopySelectedText(clear bool) tea.Cmd {
